...
public class ImageManagerViewModel : INotifyPropertyChanged
{
	...
	{
		// モデルを初期化
		imageInfoModels = new List<ImageInfoModel>();
    ...
    public List<ImageInfoModel> GetImageInfoModelListInternal()
	{
		...
		List<ImageInfoModel> imageInfoModelList = new List<ImageInfoModel>();

		ImageInfoModel imageInfoModel1 = new ImageInfoModel("image_1", "https://image-server-1/image_1.png", "Ichiro Yamada", "2025/9/1 14:00:00", 1, "");
		imageInfoModelList.Add(imageInfoModel1);


        ImageInfoModel imageInfoModel2 = new ImageInfoModel("image_2", "https://image-server-1/image_2.jpg", "Jiro Sato", "2025/9/3 16:00:00", 2, "");
		imageInfoModelList.Add(imageInfoModel2);

        ImageInfoModel imageInfoModel3 = new ImageInfoModel("image_3", "https://image-server-1/image_3.png", "Ichiro Yamada", "2025/9/1 15:00:00", 3, "");
